...
# https://raw.githubusercontent.com/Romba89/sshmws/aio/permission/ip 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/Romba89/sshmws/aio/permission/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Romba89/sshmws/aio/permission/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$WEKWEKA" ]; then
    Bloman
    else
